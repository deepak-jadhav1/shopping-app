    ...
    <div className="bg-white lg:px-20">
      <div className="pt-6">
        ...
        <section className='grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10'>
          ...
          {/* Product info */}
          <div className="lg-col-span-1 max-auto max-w-2xl px-4 pb-16 am:px-6 lg:max-w-7xl lg-px-8 lg:pb-24" >
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className='flex space-x-5 item-centre text-lg lg:text-xl text-gary-900 mt-6'>
        ...
        {/*Rating and Reviews*/}
        <section>
          <h1 className='font-sembold text-lg pb-4'>Recent Review & Rating </h1>
